...
public class ThirdActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		traceLifeCycle("T onCreate");
	}
	
	@Override
	protected void onStart() {
		super.onStart();
		traceLifeCycle("T onStart");
	}
	
	@Override
	protected void onRestart() {
		super.onRestart();
		traceLifeCycle("T onRestart");
	}
	
	@Override
	protected void onResume() {
		super.onResume();
		traceLifeCycle("T onResume");
	}
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		traceLifeCycle("T onRestoreInstanceState");
	}
	...
	public void onUserInteraction() {
		...
		if (isBackground) {
			traceLifeCycle("T onUserInteraction");
			isBackground = false;
		}
	}
	...
	protected void onUserLeaveHint() {
		...
		traceLifeCycle("T onUserLeaveHint");
		isBackground = true;
	}
	...
	protected void onPause() {
		super.onPause();
		traceLifeCycle("T onPause");
	}
	
	@Override
	protected void onNewIntent(Intent intent) {
		super.onNewIntent(intent);
		traceLifeCycle("T onNewIntent");
	}
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		traceLifeCycle("T onSaveInstanceState");
	}
	
	@Override
	protected void onStop() {
		super.onStop();
		traceLifeCycle("T onStop");
	}
	
	@Override
	protected void onDestroy() {
		super.onDestroy();
		traceLifeCycle("T onDestroy");
	}

	@Override
	public void onAttachedToWindow() {
		super.onAttachedToWindow();
		traceLifeCycle("T onAttachedToWindow");
	}
